...
### {
###     "idx": 0,
###     "pred": ["1", "1", "3"], same prompt generated responses
###     "gt": "1"
### }, ...
### ]
...
def evaluate(data_name, prompt_type, samples: list=None, file_path: str=None, max_num_samples=None, execute=False):
    ...
    # score_mat: [[true, true, true], [true, true, false], ...] list([prompt, n_sampling])
    ...
    result_json = {
        ...
        "acc": np.round(np.array(mean_score).mean(), decimals=1)
    }
